...
contract DeployNFTStaking is Script {
    address initialOwner = 0xYourInitialOwnerAddressHere; // Replace with the initial owner address
    ...
    function run() external {
        ...
        Collection collection = new Collection("Test Collection", "TEST", initialOwner);

        // Deploy N2DRewards contract
        N2DRewards rewards = new N2DRewards("Reward Token", "RTK", initialOwner);
